    ...
    _createClass(LzIntervalsTrack, [{
      ...
      value: function toggleSplitTracks() {
        ...
        if (!this.layout.split_tracks) {
          ...
          this.parent_plot.layout.min_width = 1; // recalculate prop
